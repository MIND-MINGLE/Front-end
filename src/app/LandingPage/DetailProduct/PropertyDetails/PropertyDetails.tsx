...
import PropertyDescription from '@/app/LandingPage/DetailProduct/PropertyDetails/PropertyDescription/PropertyDescription';
import OwnerContactCard from '@/app/LandingPage/DetailProduct/PropertyDetails/OwnerContactCard/OwnerContactCard';
